        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PorductCategoryId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainImageNameInFileSystem = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Shipping = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Weight = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RemindCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductCategories_PorductCategoryId",
                        column: x => x.PorductCategoryId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 11, 15, 22, 39, 39, 296, DateTimeKind.Local).AddTicks(7379), "admin", new DateTime(2024, 11, 15, 22, 39, 39, 296, DateTimeKind.Local).AddTicks(7389) });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "Name", "UpdatedAt" },
                values: new object[] { 2, new DateTime(2024, 11, 15, 22, 39, 39, 296, DateTimeKind.Local).AddTicks(7390), "user", new DateTime(2024, 11, 15, 22, 39, 39, 296, DateTimeKind.Local).AddTicks(7390) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_PorductCategoryId",
                table: "Products",
